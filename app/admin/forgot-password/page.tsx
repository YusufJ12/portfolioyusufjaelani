    ...
    try {
      ...
      if (res.ok) {
        ...
        MySwal.fire({
          ...
          text: data.message || "Masukkan kode OTP atau gunakan Master Key untuk verifikasi.",
        });
      } else {
        MySwal.fire({
          ...swalConfig,
              ...
              {!useMasterKey ? (
                <div>
                  ...
                  <div className="flex justify-between items-center mt-1">
                    <span className="text-xs text-gray-500">Cek inbox / spam email Anda</span>
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Masukkan Master Secret Key"
                  />
