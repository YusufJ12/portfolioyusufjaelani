...
async function main() {
    ...
    // Create Admin
    const hashedPassword = await bcrypt.hash("Portfolio_12", 10);
    await prisma.admin.upsert({
        where: { email: "yusufjaelani@gmail.com" },
        update: {
    ...
    const skills = [
        ...
        },
        {
            ...
            technologies: JSON.stringify([
                ...
                "Integrasi LLM (RAG Architecture)",
    ...
    const projects = [
        {
            ...
            tags: JSON.stringify([".NET 10", "ASP.NET Core", "Microsoft YARP", "Angular", "PostgreSQL 16", "Redis 7", "SignalR", "Docker"]),
            category: "Web",
            liveUrl: "",
            githubUrl: "",
            featured: true,
        ...
        },
        {
            ...
            tags: JSON.stringify(["Laravel 12", "Vue.js 3", "MySQL", "Redis Caching", "WebSocket", "Tailwind CSS"]),
            category: "Web",
            liveUrl: "",
            githubUrl: "",
            featured: true,
